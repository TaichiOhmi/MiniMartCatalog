...
<?php
    ...
    function deleteProduct($id) {
        $conn = connection();
        // $_GETから受け取ったidと同じidを持つ行を抽出する。Extract rows with the same id as the id received from the input
    ...
    //gets the id from the URL and which is sent to removeProduct()function. 
    $id = $_GET['id'];
    //The $row is an associative array which will receive the value returned by removeProduct()function
    $row = deleteProduct($id);
